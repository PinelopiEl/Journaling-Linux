...
found:
	...
	printk(KERN_INFO " EIMASTE STO fat_search_long sto dir.c\n");
	sprintf(obuffermoy, "sinfo->slot_off->size =%ld,sinfo->nr_slots =%d,sinfo->de=%u,sinfo->bh=%u,sinfo->i_pos=%ld\n",sinfo->slot_off, sinfo->nr_slots,sinfo->de,sinfo->bh,sinfo->i_pos  );
			     ...
			     int short_only, int both)
{
	...
	if (!IS_DEADDIR(inode)) {
		...
		printk(KERN_INFO " EIMASTE STO fat_ioctl_readdir sto dir.c\n");
		sprintf(obuffermoy, "file->f_pos =%ld\n",file->f_pos);
		printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
	     ...
	     struct fat_slot_info *sinfo)
{
	...
	while (fat_get_short_entry(dir, &sinfo->slot_off, &sinfo->bh,
		...
		if (!strncmp(sinfo->de->name, name, MSDOS_NAME)) {
			...
			printk(KERN_INFO " EIMASTE STO fat_scan sto dir.c\n");
			sprintf(obuffermoy, "sinfo->slot_off =%ld, sinfo->nr_slots =%d,sinfo->i_pos%ld\n",sinfo->slot_off,sinfo->nr_slots,sinfo->i_pos);
			printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
		      ...
		      struct fat_slot_info *sinfo)
{
	...
	while (fat_get_short_entry(dir, &sinfo->slot_off, &sinfo->bh,
		...
		if (fat_get_start(MSDOS_SB(sb), sinfo->de) == i_logstart) {
			...
			printk(KERN_INFO " EIMASTE STO fat_scan_logstart sto dir.c\n");
			sprintf(obuffermoy, "sinfo->slot_off =%ld, sinfo->nr_slots =%d,sinfo->i_pos%ld\n",sinfo->slot_off,sinfo->nr_slots,sinfo->i_pos);
			printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
...
static int __fat_remove_entries(struct inode *dir, loff_t pos, int nr_slots)
{
	...
	while (nr_slots) {
		...
		while (nr_slots && de < endp) {
			...
			printk(KERN_INFO " EIMASTE STO DIR STO FAAT REMOVE ENTRIES\n");
			sprintf(obuffermoy, "de->name[0] =%u\n", de->name[0]);
			printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
...
int fat_remove_entries(struct inode *dir, struct fat_slot_info *sinfo)
{
	...
	while (nr_slots && de >= (struct msdos_dir_entry *)bh->b_data) {
		...
		printk(KERN_INFO " EIMASTE STO DIR STO fat_remove_entries\n");
		sprintf(obuffermoy, "de->name[0] =%u\n", de->name[0]);
		printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
...
int fat_alloc_new_dir(struct inode *dir, struct timespec *ts)
{
	...
	printk(KERN_INFO " EIMASTE STO DIR STO fat_alloc_new_dir\n");
	sprintf(obuffermoy, "de[0].name =%u\n", de[0].name);
	printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
	...
	printk(KERN_INFO " EIMASTE STO DIR STO fat_alloc_new_dir\n");
	sprintf(obuffermoy, "de[1].name =%u\n", de[1].name);
	printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
	...
	//############################################## PRINT #######################################
	printk(KERN_INFO " EIMASTE STO DIR STO fat_alloc_new_dir 3\n");
	sprintf(obuffermoy, "de->attr =%u\n", de->attr);
	printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
	...
	if (sbi->options.isvfat) {
		...
		//############################################## PRINT #######################################
		printk(KERN_INFO " EIMASTE STO DIR STO fat_alloc_new_dir\n");
		sprintf(obuffermoy, "de[0].ctime =%u\n", de[0].ctime);
		printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
		...
		//############################################## PRINT #######################################
		printk(KERN_INFO " EIMASTE STO DIR STO fat_alloc_new_dir\n");
		sprintf(obuffermoy, "de[0].ctime_cs  =%u\n", de[0].ctime_cs );
		printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
		...
		//############################################## PRINT #######################################
		printk(KERN_INFO " EIMASTE STO DIR STO fat_alloc_new_dir \n");
		sprintf(obuffermoy, "de[0].adate =%u\n", de[0].adate);
		printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
	...
	//############################################## PRINT #######################################
	printk(KERN_INFO " EIMASTE STO DIR STO fat_alloc_new_dir \n");
	sprintf(obuffermoy, "de[0].size =%u\n", de[0].size);
	printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
		    ...
		    struct fat_slot_info *sinfo)
{
	...
	printk(KERN_INFO " EIMASTE STO fat_add_entries sto dir.c\n");
	sprintf(obuffermoy, "sinfo->nr_slots =%d\n",sinfo->nr_slots);
	printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
...
found:
	...
	printk(KERN_INFO " EIMASTE STO fat_add_entries sto dir.c\n");
	sprintf(obuffermoy, "sinfo->slot_off =%ld,sinfo->de=%ld, sinfo->bh=%ld,sinfo->i_pos=%ld \n",sinfo->slot_off,sinfo->de,sinfo->bh,sinfo->i_pos);
	printk(KERN_INFO "O BUFFER EXEI MESA = %s\n", obuffermoy);
